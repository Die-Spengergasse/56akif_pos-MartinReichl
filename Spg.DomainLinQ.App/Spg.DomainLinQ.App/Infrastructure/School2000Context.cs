...
namespace Spg.DomainLinQ.App.Infrastructure
{
    ...
    public class School2000Context : DbContext
    {
        ...
        {
            modelBuilder.Entity<SchoolClass>().HasKey(s => s.Name);
            modelBuilder.Entity<SchoolClass>().Property(s => s.Name).IsRequired();
            
            modelBuilder.Entity<Subject>().HasKey(s => s.Description);
            modelBuilder.Entity<Subject>().Property(s => s.Description).IsRequired(); 
